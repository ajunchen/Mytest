...
#define ALSPS_SUB							0X8A
#define ALSPS_SUB_SET_PS_MODE				_IOW(ALSPS_SUB, 0x01, int)
#define ALSPS_SUB_GET_PS_MODE				_IOR(ALSPS_SUB, 0x02, int)
#define ALSPS_SUB_GET_PS_DATA				_IOR(ALSPS_SUB, 0x03, int)
#define ALSPS_SUB_GET_PS_RAW_DATA				_IOR(ALSPS_SUB, 0x04, int)
#define ALSPS_SUB_SET_ALS_MODE				_IOW(ALSPS_SUB, 0x05, int)
#define ALSPS_SUB_GET_ALS_MODE				_IOR(ALSPS_SUB, 0x06, int)
#define ALSPS_SUB_GET_ALS_DATA				_IOR(ALSPS_SUB, 0x07, int)
#define ALSPS_SUB_GET_ALS_RAW_DATA				_IOR(ALSPS_SUB, 0x08, int)

/*-------------------MTK add-------------------------------------------*/
#define ALSPS_SUB_GET_PS_TEST_RESULT		_IOR(ALSPS_SUB, 0x09, int)
#define ALSPS_SUB_GET_ALS_TEST_RESULT		_IOR(ALSPS_SUB, 0x0A, int)
#define ALSPS_SUB_GET_PS_THRESHOLD_HIGH		_IOR(ALSPS_SUB, 0x0B, int)
#define ALSPS_SUB_GET_PS_THRESHOLD_LOW		_IOR(ALSPS_SUB, 0x0C, int)
#define ALSPS_SUB_GET_ALS_THRESHOLD_HIGH		_IOR(ALSPS_SUB, 0x0D, int)
#define ALSPS_SUB_GET_ALS_THRESHOLD_LOW		_IOR(ALSPS_SUB, 0x0E, int)
#define ALSPS_SUB_IOCTL_CLR_CALI			_IOW(ALSPS_SUB, 0x0F, int)
#define ALSPS_SUB_IOCTL_GET_CALI			_IOR(ALSPS_SUB, 0x10, int)
#define ALSPS_SUB_IOCTL_SET_CALI			_IOW(ALSPS_SUB, 0x11, int)
#define ALSPS_SUB_SET_PS_THRESHOLD			_IOW(ALSPS_SUB, 0x12, int)
#define ALSPS_SUB_SET_ALS_THRESHOLD			_IOW(ALSPS_SUB, 0x13, int)
#define AAL_SUB_SET_ALS_MODE			_IOW(ALSPS_SUB, 0x14, int)
#define AAL_SUB_GET_ALS_MODE			_IOR(ALSPS_SUB, 0x15, int)
#define AAL_SUB_GET_ALS_DATA			_IOR(ALSPS_SUB, 0x16, int)
//LINE<JIRA_ID><DATE20131218><add PS Calibration>zenghaihui
#define ALSPS_SUB_IOCTL_PS_CALI_START			_IOW(ALSPS_SUB, 0x17, int[2])
#define ALSPS_SUB_IOCTL_PS_SET_CALI			_IOW(ALSPS_SUB, 0x18, int[2])
#define ALSPS_SUB_IOCTL_PS_GET_CALI			_IOW(ALSPS_SUB, 0x19, int[2])
#define ALSPS_SUB_IOCTL_PS_CLR_CALI			_IO(ALSPS_SUB, 0x1A)
#define ALSPS_SUB_IOCTL_PS_CALI_RAW_DATA				_IOR(ALSPS_SUB, 0x1B, int)
//LINE<JIRA_ID><DATE20140217><wallpaper check for ms color>zenghaihui

#ifdef CONFIG_COMPAT
#define COMPAT_ALSPS_SUB_SET_PS_MODE				_IOW(ALSPS_SUB, 0x01, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_PS_MODE				_IOR(ALSPS_SUB, 0x02, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_PS_DATA				_IOR(ALSPS_SUB, 0x03, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_PS_RAW_DATA			_IOR(ALSPS_SUB, 0x04, compat_int_t)
#define COMPAT_ALSPS_SUB_SET_ALS_MODE				_IOW(ALSPS_SUB, 0x05, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_MODE				_IOR(ALSPS_SUB, 0x06, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_DATA				_IOR(ALSPS_SUB, 0x07, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_RAW_DATA			_IOR(ALSPS_SUB, 0x08, compat_int_t)

/*-------------------MTK add-------------------------------------------*/
#define COMPAT_ALSPS_SUB_GET_PS_TEST_RESULT		_IOR(ALSPS_SUB, 0x09, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_TEST_RESULT		_IOR(ALSPS_SUB, 0x0A, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_PS_THRESHOLD_HIGH		_IOR(ALSPS_SUB, 0x0B, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_PS_THRESHOLD_LOW		_IOR(ALSPS_SUB, 0x0C, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_THRESHOLD_HIGH	_IOR(ALSPS_SUB, 0x0D, compat_int_t)
#define COMPAT_ALSPS_SUB_GET_ALS_THRESHOLD_LOW		_IOR(ALSPS_SUB, 0x0E, compat_int_t)
#define COMPAT_ALSPS_SUB_IOCTL_CLR_CALI			_IOW(ALSPS_SUB, 0x0F, compat_int_t)
#define COMPAT_ALSPS_SUB_IOCTL_GET_CALI			_IOR(ALSPS_SUB, 0x10, compat_int_t)
#define COMPAT_ALSPS_SUB_IOCTL_SET_CALI			_IOW(ALSPS_SUB, 0x11, compat_int_t)
#define COMPAT_ALSPS_SUB_SET_PS_THRESHOLD			_IOW(ALSPS_SUB, 0x12, compat_int_t)
#define COMPAT_ALSPS_SUB_SET_ALS_THRESHOLD			_IOW(ALSPS_SUB, 0x13, compat_int_t)
#define COMPAT_AAL_SUB_SET_ALS_MODE				_IOW(ALSPS_SUB, 0x14, compat_int_t)
#define COMPAT_AAL_SUB_GET_ALS_MODE				_IOR(ALSPS_SUB, 0x15, compat_int_t)
#define COMPAT_AAL_SUB_GET_ALS_DATA				_IOR(ALSPS_SUB, 0x16, compat_int_t)
#endif
#endif
